...
import logo2 from '../../images/logo/logo-dark.png';
...
const SignUp = () => {
  ...
  return (
    <>
      <Nav />
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen flex items-center">
        <div className="flex flex-wrap items-center mx-auto shadow-md w-full lg:w-10/12 rounded-md">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block" src={Logo} alt="Logo" />
                <img className="dark:hidden" src={logo2} alt="Logo" />
              </Link>
              <p className="2xl:px-20">Welcome back</p>
              ...
              <div>
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-4 top-4">
                        <svg
                          ...
                          className="fill-current feather feather-phone"
                        >
                          <g opacity="0.5">
                            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.77 19.77 0 0 1-8.63-2.8A19.51 19.51 0 0 1 3.28 12.8 19.77 19.77 0 0 1 .48 4.37 2 2 0 0 1 2.46 2h3a2 2 0 0 1 2 1.72 12.05 12.05 0 0 0 .67 2.71 2 2 0 0 1-.45 2.11l-1.27 1.27a16 16 0 0 0 6.11 6.11l1.27-1.27a2 2 0 0 1 2.11-.45 12.05 12.05 0 0 0 2.71.67 2 2 0 0 1 1.72 2z" />
                          </g>
                        </svg>
                      </span>
                    </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute inset-y-0 right-3 flex items-center h-[40px] text-lg mt-2  px-2.5 z-10 bg-transparent">
                      {showPassword ? (
                        <FiEyeOff
