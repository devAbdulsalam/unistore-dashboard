  ...
  return (
    <div className="relative">
      <Link
        ...
        to="#"
        className="relative flex h-8.5 w-8.5  rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
      >
        ...
        <span className="h-4.5 w-4.5 rounded-full">
          <img
            ...
            width="18"
            height="18"
            className="h-4.5 w-4.5 rounded-full overflow-hidden"
          />
        </span>
